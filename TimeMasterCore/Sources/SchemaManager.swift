        ...
        let objects: [String: ObjectSchema] = [
            "page": ObjectSchema(
                ...
                properties: [
                    ...
                    "pageKind": PropertySchema(type: "string", description: "Structural role: container pages organize or hold children; leaf pages are exercises", optional: true),
                    "pageType": PropertySchema(type: "string", description: "Optional content type: exercise, skill, or tutorial", optional: true),
                    "coverImageFilename": PropertySchema(type: "string", description: "Legacy cover filename; new pages use the first ordered media item", optional: true),
                    ...
                    "linkedPageIDs": PropertySchema(type: "array<string>", description: "References to any attached database pages", optional: true),
                    ...
                    "skillStatus": PropertySchema(type: "string", description: "Skill or tutorial state: notStarted, learning, completed", optional: true),
                    "skillBoardSectionID": PropertySchema(type: "string", description: "Optional custom skill board section ID", optional: true),
                    "skillBoardOrder": PropertySchema(type: "integer", description: "Order inside a skill board status and section", optional: true),
                    "skillBoardSections": PropertySchema(type: "array<object>", description: "Custom sections owned by a container skill board", optional: true),
                    "duration": PropertySchema(type: "integer", description: "Exercise duration in seconds; absent for skills and tutorials", format: "seconds", optional: true),
                    "restAfter": PropertySchema(type: "integer", description: "Rest after an exercise in seconds; absent for skills and tutorials", format: "seconds", optional: true),
                    "prepareTime": PropertySchema(type: "integer", description: "Preparation before each exercise set in seconds", format: "seconds", optional: true),
                    "sets": PropertySchema(type: "integer", description: "Default exercise set count", optional: true),
                    "restBetweenSets": PropertySchema(type: "integer", description: "Rest between exercise sets in seconds", format: "seconds", optional: true),
                    "dropSetTemplates": PropertySchema(type: "array<object>", description: "Exercise drop-set templates", optional: true),
                    "childIDs": PropertySchema(type: "array<string>", description: "Ordered direct child page IDs", optional: true),
