...
| `P08 - Human PR Creation.md` | PR-01 | Create a pull request with a human-sounding message. Picks the right Git route (own repo, fork, clone). Writes in B2 English — short sentences, no AI voice, bullet points not paragraphs. Adapts message size to change size. |
